...
df=df.replace(to_replace ='BAIRITE', value ="BARTE", regex= True)
...
df=df.replace(to_replace='pumacite', value='pumice', regex= True)
...
df=df.replace(to_replace='soduim nitrate', value='sodium nitrate', regex= True)
df=df.replace(to_replace='stivnite', value='stibnite', regex= True)
df=df.replace(to_replace='sulphur deposites', value='sulfur', regex= True) 
...
df=df.replace(to_replace='zinc)', value='zinc', regex= False)
...
df=df.replace(to_replace='and barium', value='barium', regex= True)
...
df=df.replace(to_replace='oil shale', value='petrolium (oil), oil shale', regex= False)
...
df=df.replace(to_replace='barite deposits', value='barite', regex= True)
...
df=df.replace(to_replace='tungsten, silver', value='tungsten; silver', regex= True)
df=df.replace(to_replace='gold;', value='gold', regex= True)
df=df.replace(to_replace='silver, lead', value='silver lead (respectively)', regex= True)
df=df.replace(to_replace='coal (lignite)', value='coal, lignite', regex= True)
df=df.replace(to_replace='barite gold', value='gold', regex= True)
df=df.replace(to_replace='minor sulhumboldtides', value='sulfides', regex= True)
df=df.replace(to_replace='montmorillinitic clay', value='montmorillonite', regex= True)
df=df.replace(to_replace='alum', value='aluminum', regex= True)
df=df.replace(to_replace='base and precious metals', value='base ', regex= True)
df=df.replace(to_replace='clay?', value='clay', regex= True)
df=df.replace(to_replace='and small amounts ohumboldt arsenic', value='arsenic', regex= True)
df=df.replace(to_replace='sercite', value='sericite', regex= True)
df=df.replace(to_replace='lead, zinc, copper, silver', value='lead; zinc; copper; silver', regex= True)
df=df.replace(to_replace='special clays', value='clay', regex= True)
df=df.replace(to_replace='and minor ammounts ohumboldt mercury', value='mercury', regex= True)
df=df.replace(to_replace='decorative rock', value='stone', regex= True)
df=df.replace(to_replace='gold placers', value='placer gold', regex= True)
df=df.replace(to_replace='milybdenum', value='molybdenum', regex= True)
df=df.replace(to_replace='colbalt', value='cobalt', regex= True)
df=df.replace(to_replace='mersury', value='mercury', regex= True)
df=df.replace(to_replace='iron, magnesium, lead, copper', value='iron; magnesium; lead; copper', regex= True)
df=df.replace(to_replace='zince', value='zinc', regex= True)
df=df.replace(to_replace='betonite', value='bentonite', regex= True)
df=df.replace(to_replace='some copper and zinc', value='copper; zinc', regex= True)
df=df.replace(to_replace='mangansese', value='manganese', regex= True)
df=df.replace(to_replace='phosphorus', value='phosphorus-phosphates', regex= True)
df=df.replace(to_replace='sulhumboldtate', value='sulfate', regex= True)
df=df.replace(to_replace='dimension stone', value='stone, dimension', regex= True)
df=df.replace(to_replace='iron ore', value='iron', regex= True)
df=df.replace(to_replace='gysum', value='gypsum', regex= True)
df=df.replace(to_replace='chrysacolla', value='chrysocolla', regex= True)
df=df.replace(to_replace='asphalt', value='petroleum (oil), rock asphalt', regex= False)
df=df.replace(to_replace='manganese ore', value='manganese', regex= True)
df=df.replace(to_replace='cement', value='aggregate', regex= True)
df=df.replace(to_replace='tungsten ore (scheelite)', value='scheelite', regex= True)
df=df.replace(to_replace='volcanid ash', value='ash', regex= True)
df=df.replace(to_replace='wulhumboldtenite observed', value='wulfenite', regex= True)
df=df.replace(to_replace='copper, iron', value='copper; iron', regex= True)
df=df.replace(to_replace='manganese dioxide', value='pyrolusite', regex= True)
df=df.replace(to_replace='silver, gold', value='silver; gold', regex= True)
df=df.replace(to_replace='pitchblende', value='uraninite', regex= True)
df=df.replace(to_replace='& talcose minerals', value='talc; chlorite; pyrophyllite', regex= True)
df=df.replace(to_replace='ceragyrite', value='cerargyrite', regex= True)
df=df.replace(to_replace='copper. silver', value='copper, silver', regex= True)
df=df.replace(to_replace='sand & gravel', value='sand and gravel', regex= True)
df=df.replace(to_replace='ornamental stone', value='stone', regex= True)
df=df.replace(to_replace='oil?', value='petroleum (oil)', regex= True)
df=df.replace(to_replace='tungsten?', value='tungsten', regex= True)
df=df.replace(to_replace='zinc-sulhumboldtide', value='zinc sulfide', regex= True)
df=df.replace(to_replace='gold quarry mine', value='gold', regex= True)
df=df.replace(to_replace='clay;', value='clay', regex= True)
df=df.replace(to_replace=' montmorillonite clay', value='montmorillonite', regex= True)
df=df.replace(to_replace='argentihumboldterous cerussite', value='cerussite', regex= True)
df=df.replace(to_replace='asphaltite', value='petroleum (oil), rock asphalt', regex= False)
df=df.replace(to_replace='limestone aggregate', value='limestone; aggregate', regex= True)
df=df.replace(to_replace='malacite', value='malachite', regex= True)
df=df.replace(to_replace='kaolin', value='kaolinite', regex= True)
df=df.replace(to_replace='lead-sillver', value='lead silver', regex= True)
df=df.replace(to_replace='decorative and dimension stone', value='stone; stone, dimension', regex= True)
df=df.replace(to_replace='ruby silver', value='pyrargyrite', regex= True)
df=df.replace(to_replace='sheelite', value='scheelite', regex= True)
df=df.replace(to_replace='some bismuth', value='bismuth', regex= True)
df=df.replace(to_replace='sodium sulphate', value='sodium sulfate', regex= True)
df=df.replace(to_replace='silver, arsenic', value='silver; arsenic', regex= True)
df=df.replace(to_replace='bentonite clay', value='bentonite', regex= True)
df=df.replace(to_replace='silver sulfides and preciuos-metals', value='silver sulfide; precious metals', regex= True)
df=df.replace(to_replace='carbonate/ dolomite/ limestone', value='carbonate; dolomite; limestone', regex= True)
df=df.replace(to_replace='meerschaum', value='sepolite (meerschaum)', regex= True)
df=df.replace(to_replace='sodium sufate', value='sodium sulfate', regex= True)
df=df.replace(to_replace='aluminous minerals', value='aluminum, contained or metal   ', regex= True)
df=df.replace(to_replace='nickle', value='nickel', regex= True)
df=df.replace(to_replace='sepiolite', value='sepolite (meerschaum)', regex= True)
df=df.replace(to_replace='fluorite;', value='fluorite', regex= True)
df=df.replace(to_replace='ag', value='silver', regex= True)
df=df.replace(to_replace='zinc;', value='zinc', regex= True)
df=df.replace(to_replace='gold, silver, cadmium', value='gold; silver; cadmium', regex= True)
df=df.replace(to_replace='oil and gas', value='petroleum (oil); natural gas', regex= True)
df=df.replace(to_replace='electrum ore (gold', value='gold', regex= False)
df=df.replace(to_replace='vanadiuml zinc', value='vanadium; zinc', regex= True)
df=df.replace(to_replace='lead  tungsten', value='lead tungsten', regex= True)
df=df.replace(to_replace='(magnesium-silicate)', value=' ', regex= True)
df=df.replace(to_replace='aluminum minerals', value='aluminum, contained or metal', regex= True)
df=df.replace(to_replace='boron chemicals', value='boron', regex= True)
df=df.replace(to_replace='crystals: epidote', value='epidote', regex= True)
df=df.replace(to_replace='gold, silver, zinc', value='gold; silver; zinc', regex= True)
df=df.replace(to_replace='limestone (dimension stone)', value='limestone; stone, dimension', regex= True)
df=df.replace(to_replace='quicksilver', value='mercury', regex= True)
df=df.replace(to_replace='bromide', value='bromine', regex= True)
df=df.replace(to_replace='silver-lead-zinc', value='silver zinc lead', regex= True)
df=df.replace(to_replace='and minor amounts of arsenic', value='arsenic', regex= True)
df=df.replace(to_replace='molybdeaum', value='molybdenum', regex= True)
df=df.replace(to_replace='vanandinite', value='vanadinite', regex= True)
df=df.replace(to_replace='gold (placer)', value='placer gold', regex= True)
df=df.replace(to_replace='gold geothermal resources', value='gold geothermal', regex= True)
df=df.replace(to_replace='sulphur', value='sulfur', regex= True)
df=df.replace(to_replace='silver, copper', value='silver; copper', regex= True)
df=df.replace(to_replace='gypsum-anhydrite', value='gypsum; anhydrite', regex= True)
df=df.replace(to_replace='cinder pumice', value='cinder; pumice', regex= True)
df=df.replace(to_replace='vanadium-zinc', value='vanadium; zinc', regex= True)
df=df.replace(to_replace='some tungsten', value='tungsten', regex= True)
df=df.replace(to_replace='bentonite/mineral soap', value='bentonite; mineral soap', regex= True)
df=df.replace(to_replace='trace copper', value='copper', regex= True)
df=df.replace(to_replace='idocrase', value='vesuvianite (idocrase)', regex= True)
df=df.replace(to_replace='g0ld', value='gold', regex= True)
df=df.replace(to_replace='lease minerals', value='leasable minerals', regex= True)
df=df.replace(to_replace='tungsten mines', value='tungsten', regex= True)
df=df.replace(to_replace='zeolite', value='zeolites', regex= True)
df=df.replace(to_replace='sand and gravel;', value='sand; gravel', regex= True)
df=df.replace(to_replace='travertine (building stone?)', value='travertine', regex= True)
df=df.replace(to_replace='minor amounts of copper-lead', value='lead copper', regex= True)
df=df.replace(to_replace='wollastorite', value='wollastonite', regex= True)
df=df.replace(to_replace='nickel-cobalt', value='nickel cobalt', regex= True)
df=df.replace(to_replace='onyx', value='onyx (black agate)', regex= True)
df=df.replace(to_replace='stivnite', value='stibnite', regex= True)
df=df.replace(to_replace='varicite', value='variscite', regex= True)
df=df.replace(to_replace='dolomitic marble', value='marble', regex= True)
df=df.replace(to_replace='coppery', value='copper', regex= True)
df=df.replace(to_replace='gypsum,', value='gypsum', regex= True)
df=df.replace(to_replace='gold, silver, copper, and lead', value='gold; silver; copper; lead', regex= True)
df=df.replace(to_replace='silver-lead', value='lead silver', regex= True)
df=df.replace(to_replace='water-lain tuffite', value='tuff', regex= True)
df=df.replace(to_replace='gold, silver', value='gold; silver', regex= True)
df=df.replace(to_replace='silver)', value='silver', regex= False)
df=df.replace(to_replace='montmorillonite;', value='montmorillonite', regex= True)
df=df.replace(to_replace='pumice & tuff', value='pumice; tuff', regex= True)
df=df.replace(to_replace='sulfide copper', value='copper sulfide', regex= True)
df=df.replace(to_replace='zinc-lead', value='zinc lead', regex= True)
df=df.replace(to_replace='rock', value='aggregate', regex= True)
df=df.replace(to_replace='dolomite limestone', value='limestone', regex= True)
df=df.replace(to_replace='unknown', value=' ', regex= True)
df=df.replace(to_replace='gold?', value='gold', regex= True)
df=df.replace(to_replace='some anomalous arsenic', value='arsenic', regex= True)
df=df.replace(to_replace='talc & related minerals', value='talcose minerals', regex= True)
df=df.replace(to_replace='clay deposits', value='clay', regex= True)
df=df.replace(to_replace='fluorspar and precious-metals', value='fluorspar; precious metals', regex= True)
df=df.replace(to_replace='none', value=' ', regex= True)
df=df.replace(to_replace='diatomite;', value='diatomite', regex= True)
